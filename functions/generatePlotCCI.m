function [CCI,CC,cci,maxCCI] = generatePlotCCI(t,mus1, mus2, tileInd,opts)
...
CCI = [calcCCI(mus1, mus2, 1), calcCCI(mus1, mus2, 2)/100, calcCCI(mus1, mus2, 3),calcCCI(mus1, mus2, 4),CCt,calcCCI(mus1, mus2, 5)];

maxCCI = ([calcCCI(maxMus, maxMus, 1), calcCCI(maxMus, maxMus, 2)/100, calcCCI(maxMus, maxMus, 3),NaN,1,calcCCI(maxMus, maxMus, 5)]);
